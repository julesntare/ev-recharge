...
class LocationUpdatesService : Service() {
    ...
    fun onNewLocation(location: Location) {
        ...
        val getLocation: Location = location

        println(sharedPreferences.getString(PLACE_ID, ""))
...
//                sendNotification(this, getLocation.provider!!)
                ...
                pushNotification.putExtra("updatedLocation", getLocation)
    ...
    private fun sendNotification(context: Context, placeId: String) {
        try {
            ...
            val notificationIntent = Intent(context, MapsActivityTest::class.java)

            // Construct a task stack.
            val stackBuilder = TaskStackBuilder.create(context)

            // Add the main Activity to the task stack as the parent.
            stackBuilder.addParentStack(MapsActivityTest::class.java)
